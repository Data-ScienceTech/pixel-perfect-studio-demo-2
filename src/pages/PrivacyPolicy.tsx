      ...
      <main className="pt-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="prose prose-gray max-w-none">
            ...
            <p className="text-lg text-emerald-600 mb-8">Last updated: {new Date().toLocaleDateString()}</p>
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <h3 className="text-xl font-medium text-emerald-800 mb-3">2.1 Personal Information</h3>
                <p className="text-emerald-700 leading-relaxed mb-4">
                  We may collect personal information that you voluntarily provide to us when you:
                </p>
                <ul className="list-disc list-inside text-emerald-700 space-y-2 mb-4 ml-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-emerald-900 mb-4">4. Cookies and Tracking</h2>
                <p className="text-emerald-700 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-emerald-900 mb-4">5. Your Rights</h2>
                <p className="text-emerald-700 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-emerald-900 mb-4">6. Contact Information</h2>
                <p className="text-emerald-700 leading-relaxed">
                  If you have any questions about this Privacy Policy, please contact us at:
                </p>                <div className="bg-emerald-50 p-4 rounded-lg mt-4">
